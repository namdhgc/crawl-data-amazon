...
return array(
    ...
    */
    ...
    'manage' => [
        'transaction-detail'  => [
            'file-Name' => 'Danh sách chi tiết giao dịch',
            'title' => 'Danh sách chi tiết giao dịch',
            'arrayTitle' => [
                'stt'   => [
                    'type'  => 'text',
                    'label' => 'STT'
                ...
                'total_price_in_jp'   => [
                    'type'  => 'text',
                    'label' => 'Giá trị đơn hàng tại Amazon'
                ],
                'real_price'   => [
                    'type'  => 'text',
                    'label' => 'Giá trị thực của đơn hàng'
                ],
                'difference'   => [
                    'type'  => 'text',
                    'label' => 'Chênh lệch',
