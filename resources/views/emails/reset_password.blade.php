...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  <?php $link_route = ($data['is_admin'])? 'guest-get-reset-password': 'web-get-reset-password'; ?>
                              ...
                              <tr>
                                <td align="center">
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td>
                                        <a href="{{  URL::Route($link_route, ['username' => $data['username'], 'token_reset_password' => $data['token_reset_password'] ]) }}" class="button button--green" target="_blank">Reset your password</a>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
