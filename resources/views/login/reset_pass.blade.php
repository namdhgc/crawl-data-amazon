...
<body class=" login">
    ...
    <!-- BEGIN LOGIN -->
    <div class="content">
        <form class="login-form" action="{{ URL::Route('guest-post-change-password') }} " method="post" >
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input class="form-control placeholder-no-fix" type="password" id="password" autocomplete="off" placeholder="Mật khẩu mới" name="password" /> </div>
            </div>
            <div class="form-group">
                <label class="control-label ">Gõ lại mật khẩu mới:</label>
                <div class="input-icon">
                    <i class="fa fa-lock"></i>
                    <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Gõ lại mật khẩu mới" name="password_retype" /> </div>
            </div>
            <div class="form-actions">
                <button type="submit" class="btn green pull-right"> Cập nhật </button>
                @if($errors->any())
