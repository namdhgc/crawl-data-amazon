...
@section('title')
    <title>{{ Lang::get('menu.manager-frequently-asked-questions') }}</title>
@endsection
...
@section('js')
    ...
    <script src="{{ URL::asset('js/manage/faq/frequently_asked_questions.js') }}" ></script>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box blue" id="search-tool">
                ...
                <div class="portlet-body"  style="display: block;">
                    ...
                    <form action="{{ URL::Route('auth-get-frequently-asked-questions') }}" method="GET" id="search-tool" >
            ...
            <div class="portlet light bordered clearfix">
                <div class="portlet-title">
                    <div class="caption ">
                        ...
                        <span class="caption-subject bold uppercase font-green">{{ Lang::get('menu.manager-frequently-asked-questions') }}</span>
                    </div>
                    <div class="actions">                 
                    </div>
                        ...
                        <table class="table table-striped table-hover order-column dataTable" id="dataTable">
                            <thead>
                                <tr>
                                    ...
                                    <?php echo Spr\Base\Controllers\Views\DataTable::headerCellTable($data, 'Câu hỏi','',''); ?>
                                    <?php echo Spr\Base\Controllers\Views\DataTable::headerCellTable($data, 'Câu trả lời','',''); ?>
                                </tr>
                            </thead>
                            <tbody>
                                @if(isset($data))
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <h4 class="modal-title">{{ Lang::get('frequently-asked-questions.form-delete') }}</h4>
                      </div>
                      <div class="modal-body">
                            <form class="form-action form-delete" method="POST" action="{{ URL::Route('auth-post-delete-frequently-asked-questions') }}" id="frm_del" >
        ...
        <div class="modal fade modal-form-data" id="modalEdit" role="dialog">
            <div class="modal-dialog">
                <!-- Modal content-->
                <div class="modal-content">
                    <form action="{{ URL::Route('auth-post-insert-or-update-frequently-asked-questions') }}" method="POST" class="form-edit form-action" id="form-add-edit-frequently-asked-questions">
                        <div class="modal-header">
                            <div class="caption">
                                <i class=" icon-layers font-red"></i>
                                <span class="caption-subject font-red sbold uppercase">{{ Lang::get('frequently-asked-questions.add-edit-frequently-asked-questions') }}</span>
                            </div>
                        </div>
                        <div class="modal-body">
                            <!-- BEGIN FORM-->
                                ...
                                <div class="form-body">
                                    <div class="form-group form-md-line-input">
                                        <textarea class="form-control" id="question" name="question" rows="5">{{ old('question') }}></textarea>
                                        <label for="question">{{ Lang::get('frequently-asked-questions.question') }}</label>
                                        <span class="help-block">{{ Lang::get('frequently-asked-questions.help-block-question') }}</span>
                                    </div>
                                    <div class="form-group form-md-line-input">
                                        <textarea class="form-control" id="answer" name="answer" rows="5">{{ old('answer') }}></textarea>
                                        <label for="answer">{{ Lang::get('frequently-asked-questions.answer') }}</label>
                                        <span class="help-block">{{ Lang::get('frequently-asked-questions.help-block-answer') }}</span>
                                    </div>
                                </div>
                        </div>
