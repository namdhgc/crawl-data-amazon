...
@section('title')
    <title>{{ Lang::get('price.surcharge-price-list.title') }}</title>
@endsection
    ...
    <div class="row">
        ...
        <div class="portlet box blue" id="search-tool">
                ...
                <div class="portlet-body"  style="display: block;">
                    <form action="{{ URL::Route('auth-get-surcharge-price-list') }}" method="GET" id="search-tool" >
            ...
            <div class="portlet light bordered clearfix">
                <div class="portlet-title">
                    <div class="caption ">
                        ...
                        <span class="caption-subject bold uppercase font-green">{{ Lang::get('price.surcharge-price-list.title') }}</span>
                    </div>
                    <div class="actions">
                    ...
                    <table class="table table-striped table-hover order-column dataTable" id="dataTable">
                        <thead>
                            <tr>
                                ...
                                <?php echo Spr\Base\Controllers\Views\DataTable::headerCellTable($data, 'Name','',''); ?>
                                <?php echo Spr\Base\Controllers\Views\DataTable::headerCellTable($data, 'Type','',''); ?>
                                <?php echo Spr\Base\Controllers\Views\DataTable::headerCellTable($data, 'Description','',''); ?>
                            ...
                            @if(isset($data))
                                ...
                                <tr class="odd gradeX"  <?php echo Spr\Base\Controllers\Views\DataTable::attrData($item); ?>>
                                    ...
                                    <td class="type">
                                        ...
                                        @foreach(Config::get('spr.type.type.price') as $k => $val)
                    ...
                    <div class="modal fade modal-form-data" id="modalEdit" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ URL::Route('auth-post-surcharge-price-list-manager') }}" method="POST" class="form-edit form-action form-horizontal form-bordered" id="form-action-transaction-status">
                                    <div class="modal-body">
                                        <input type="hidden" id="token" name="_token" value="{{ csrf_token() }}">
                                        <input type="hidden" name="id" id="id" value="">
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <label class="control-label col-md-3 font-blue bold" for="name">{{ Lang::get('price.surcharge-price-list.name.title') }}</label>
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control" id="name" name="name">
                                                    <span class="help-block">{{ Lang::get('price.surcharge-price-list.name.help-block') }}</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="control-label col-md-3 font-blue bold" for="name">{{ Lang::get('price.surcharge-price-list.type.title') }}</label>
                                                <div class="col-md-9">
                                            ...
                                            <div class="form-group form-md-line-input ">
                                                <label class="control-label col-md-3 font-blue bold" for="description">{{ Lang::get('price.surcharge-price-list.description.title') }}</label>
                                                <div class="col-md-9">
                                                    <textarea class="form-control" id="description" name="description" rows="3"></textarea>
                                                    <span class="help-block">{{ Lang::get('price.surcharge-price-list.description.help-block') }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="modal fade in" id="modal-price-list-detail" role="dialog">
                        <div class="modal-dialog modal-full">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <h4 class="modal-title caption-subject bold uppercase font-green">{{ Lang::get('price.surcharge-price-list-detail.title') }}</h4>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                    ...
                    <div id="deleteModal" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                    <form class="form-delete"  method="POST" action="{{ URL::Route('auth-post-delete-surcharge-price') }}" id="frm_del" >
                                        <input type="hidden" id="token" name="_token" value="{{ csrf_token() }}">
