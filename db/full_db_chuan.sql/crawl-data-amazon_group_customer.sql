...
LOCK TABLES `group_customer` WRITE;
/*!40000 ALTER TABLE `group_customer` DISABLE KEYS */;
INSERT INTO `group_customer` VALUES (3,'Nhóm 12',8,1,1500879100,1500879107,NULL);
/*!40000 ALTER TABLE `group_customer` ENABLE KEYS */;
UNLOCK TABLES;
