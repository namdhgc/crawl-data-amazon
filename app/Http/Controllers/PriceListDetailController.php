...
class PriceListDetailController  extends Controller
{
    ...
    public function insertData($data_output_validate_param){
        ...
        if ($data_output_validate_param['meta']['success']) {
            ...
            $id    = $ModelPriceListDetail->insertData($data)['response'];
    ...
    public function updateData($data_output_validate_param) {
         ...
         if ($data_output_validate_param['meta']['success']) {
            ...
            $ModelPriceListDetail = new ModelPriceListDetail();
            $data_output_validate_param = $ModelPriceListDetail->updateData($data, $where);
    ...
    public function getData($data_output_validate_param) {
            ...
            if ($data_output_validate_param['meta']['success'])
            {
                ...
                $ModelPriceListDetail = new ModelPriceListDetail();
                $results = $ModelPriceListDetail->selectData($price_id);
                return $results;
            } else {
