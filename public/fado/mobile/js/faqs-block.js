;(function($, window, document, undefined){
    ...
    var faqBoxEle = faqsBlockEle.find(".faq-panel");

		/* ========================================================================
      Expand/Unexpand faq box item
		=========================================================================== */
		(function(){
      var boxHeadEle        = faqBoxEle.find(".panel-head");
      var boxMainEle        = faqBoxEle.find(".panel-main");
      ...
      boxHeadEle.click(function (){
        thatEle  = $(this);
        boxParentEle = thatEle.parents(".faq-panel");
        boxMainCurrentEle   = boxParentEle.find(".panel-main");
